...
for ep in range(epochs):
    w_lookahead = weights - learning_rate * beta * v_w
    linear_output = np.dot(X_train, w_lookahead) + bias
...
plt.title("Vanilla GD + NAG: Loss Curve")
plt.xlabel("Epoch")
...
plt.colorbar()
plt.title("Vanilla GD + NAG: Confusion Matrix")
